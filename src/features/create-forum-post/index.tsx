    ...
    <div className="flex flex-col gap-[19px] lg:flex-row lg:gap-[45px]">
      <div className="w-full lg:flex-1 flex flex-col">
        ...
        {selectedTab === 'Image' && (
          <div
            className={classNames(
              'flex flex-col gap-5 mb-8 py-7 px-6 border-dashed justify-center',
          ...
          >
            ...
            <div className="flex flex-col">
              <h4 className="text-sm font-Inter font-[400] leading-[140%] text-[#475367]">
                <span className="text-[#17CAC6] cursor-pointer font-[600]">Click to upload</span> or
                drag and drop
              </h4>
            ...
            <button className="bg-[#17CAC6] text-white px-4 py-2 rounded-[6px] font-Inter font-[600] text-sm">
              Browse Files
            </button>
          </div>
        )}
