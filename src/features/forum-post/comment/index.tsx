...
export const Comment = ({ data, refresh, disabled, postId }: Props) => {
    ...
    <div className="flex flex-col">
      <div className="flex flex-row items-center gap-[10px]">
        ...
        <div className="flex items-center gap-1">
          <p
            className="font-Trap-700 text-xs text-black leading-[140%]"
            style={{
              color: data.deleted ? '#6D6D6D' : '#000',
              fontStyle: data.deleted ? 'italic' : 'normal',
            }}
          >
            {data.deleted ? 'Deleted Comment' : data.posterUsername}
          </p>
          <svg
            width="3"
            height="3"
      ...
      <div className="flex flex-row gap-5">
        ...
        <div className="flex flex-col gap-[5px] py-[5px] flex-1">
          <div
            className="font-Trap-500 text-xs leading-[140%]"
            style={{
              color: data.deleted ? '#6D6D6D' : '#4C5965',
              fontStyle: data.deleted ? 'italic' : 'normal',
            }}
          >
            {data.deleted ? (
              ...
              <div dangerouslySetInnerHTML={createSanitizedMarkup(data.message)} />
            )}
          </div>
          ...
          {!data.deleted && (
            ...
            >
              ...
              >
                <button onClick={handleUpvotePost} disabled={interacting === 'upvote'}>
                  <svg
                    width="14"
                    height="15"
                    viewBox="0 0 14 15"
                ...
                <button onClick={handleDownvotePost} disabled={interacting === 'downvote'}>
                  <svg
                    width="14"
                    height="15"
                    viewBox="0 0 14 15"
      ...
      {data.comments.length > 0 && showReplies && (
      ...
      <ReplyInput
        ...
        placeholder={`Replying to ${data.posterUsername}`}
        visible={showEditor}
