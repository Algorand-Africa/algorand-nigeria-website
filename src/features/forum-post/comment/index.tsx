    ...
    <div className="flex flex-col">
      <div className="flex flex-row items-center gap-[10px]">
        <img
          ...
          alt={data.posterUsername}
          className="w-[25px] h-[25px] object-cover rounded-full"
        />
        <div className="flex items-center gap-1">
          <p className="font-Trap-700 text-xs text-black leading-[140%]">{data.posterUsername}</p>
          <svg
            width="3"
            height="3"
            viewBox="0 0 3 3"
      ...
      <div className="flex flex-row gap-5">
        ...
        <div className="flex flex-col gap-[5px] py-[5px] flex-1">
          <div
            dangerouslySetInnerHTML={createSanitizedMarkup(data.message)}
            className="font-Trap-500 text-xs leading-[140%] text-[#4C5965]"
          ></div>
