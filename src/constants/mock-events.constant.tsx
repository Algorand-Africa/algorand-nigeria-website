...
export const REAL_PAST_EVENTS: IPastEvent[] = [
  {
    ...
    description:
      'The engagement with the SEC sought to gather critical stakeholders within the SEC, Capital markets, and broader public sector to understand their challenges and explore areas where blockchain can solve some of those challenges.',
    image: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542381/sec_oqmmu7.jpg',
    location: 'SEC Towers, Abuja',
    date: 'Feb 4, 2025',
    images: [
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542385/GjCZ2rMXwAAgJsV_yqynon.jpg',
        alt: 'Event Image 1',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542440/photo_2025-02-04_19-19-55_xpkmgu.jpg',
        alt: 'Event Image 2',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542383/sec_2_em9y3q.jpg',
        alt: 'Event Image 3',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542381/sec_oqmmu7.jpg',
        alt: 'Event Image 4',
        fullWidth: false,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542377/sec_meeting_b6yiz8.jpg',
        alt: 'Event Image 5',
        fullWidth: false,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741542376/GjCZ6DsXYAAqiLh_uk71yb.jpg',
        alt: 'Event Image 6',
        fullWidth: true,
      },
    ],
    id: 'nigeria-blockchain-partnership-for-real-world-impact-with-sec-nigeria',
    descriptionParagraphs: [
      `In a significant step toward aligning blockchain innovation with regulatory frameworks, the Algorand Foundation team engaged with the Securities and Exchange Commission (SEC) Nigeria at SEC Towers, Abuja, on February 4, 2025. The discussions brought together key stakeholders from the SEC, capital markets, and the broader public sector to explore how blockchain can address industry challenges. Led by Algorand’s Eric Wragge, Matt Keller, and Ben Onuoha, the engagement highlighted the transformative potential of blockchain technology in financial markets, regulatory compliance, and economic growth. The presence of SEC’s Director General, Dr. Emomotimi Agama, underscored the commission’s openness to innovation and collaboration.`,
      `Throughout the session, participants delved into real-world blockchain applications that could streamline capital market operations, enhance transparency, and improve financial inclusion. The exchange of ideas between the SEC and Algorand’s representatives signaled a shared commitment to shaping a regulatory landscape that fosters responsible blockchain adoption. Industry organizations like BICCoN and Convexity also contributed to the dialogue, reinforcing the broader efforts to ensure blockchain’s full potential is realized in Nigeria. As regulatory clarity remains a key driver for mainstream adoption, such conversations play a crucial role in bridging the gap between policymakers and innovators.`,
      `This engagement marks just the beginning of deeper collaborations aimed at positioning Nigeria as a leader in blockchain-powered financial innovation. As Algorand Nigeria continues to work closely with regulators and industry stakeholders, the momentum from this event is expected to pave the way for real-world implementations of blockchain solutions in the Nigerian capital markets. With partnerships strengthening and dialogues expanding, the future of blockchain regulation in Nigeria looks promising. Watch this space! 🚀`,
    ],
  },
  {
    ...
    image:
      'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741544589/WhatsApp_Image_2025-03-09_at_7.12.21_M_bviawu.jpg',
    images: [
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741544589/WhatsApp_Image_2025-03-09_at_7.12.21_M_bviawu.jpg',
        alt: 'Event Image 1',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741544589/WhatsApp_Image_2025-03-09_at_7.12.20_PM_lp8gf1.jpg',
        alt: 'Event Image 2',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741544590/WhatsApp_Image_2025-03-09_at_7.12.21_PM_yvibg6.jpg',
        alt: 'Event Image 3',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741544592/WhatsApp_Image_2025-03-09_at_7.13.19_PM_vp3hnz.jpg',
        alt: 'Event Image 4',
        fullWidth: true,
      },
      {
        url: 'https://res.cloudinary.com/dy7olyvi0/image/upload/v1741544593/WhatsApp_Image_2025-03-09_at_7.13.20_PM_nr8g3d.jpg',
        alt: 'Event Image 5',
        fullWidth: true,
      },
    ],
    descriptionParagraphs: [
      `On February 6, 2025, industry leaders, fintech entrepreneurs, and blockchain innovators gathered at the prestigious Eko Hotel and Towers in Victoria Island, Lagos, for the Algorand Nigeria Fintech Dinner. This exclusive networking event provided a relaxed yet impactful setting for discussions on Algorand’s cutting-edge technology and its transformative potential in financial services. With over 15 key industry players in attendance, the evening served as a melting pot of ideas, fostering connections between blockchain enthusiasts and financial sector stakeholders eager to explore the future of decentralized finance.`,
      `The discussions revolved around real-world applications of Algorand’s high-performance blockchain, highlighting its ability to enhance efficiency, transparency, and scalability in financial services. From streamlining payment infrastructures to revolutionizing digital asset management, attendees explored how Algorand’s unique approach to blockchain innovation could address critical industry challenges. Much like its engagement with regulators, Algorand Nigeria continues to emphasize the importance of collaboration between emerging technology pioneers and traditional financial institutions to drive responsible blockchain adoption.
`,
...
export const REAL_UPCOMING_EVENTS: IUpcomingEvent[] = [
  {
    ...
    location: 'Virtual',
    rsvp: ' https://bit.ly/Algong-CounterFix',
    description:
  ...
  },
  {
    ...
    rsvp: 'https://bit.ly/algongP2Pcoding',
